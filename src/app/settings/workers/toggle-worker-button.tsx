...
import { toggleWorkerAction } from "./actions";
...
export function ToggleWorkerButton({ workerId, displayName, disabled }: Props) {
    ...
    function onConfirm(e: React.MouseEvent<HTMLButtonElement>) {
        ...
        startTransition(async () => {
            try {
                await toggleWorkerAction(workerId, !willEnable);
            } catch (err) {
