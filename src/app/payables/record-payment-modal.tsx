...
export function RecordPaymentModal({
    ...
    const maxAmount = Number(payableAmount);
        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {supplierName} · Outstanding {formatAmount(maxAmount)}
                    </DialogDescription>
                </DialogHeader>

                <form onSubmit={handleSubmit} className="space-y-4 p-4 sm:p-6">
                    <div className="space-y-1.5">
                        <label className="text-sm font-medium" htmlFor="cp-date">
                            Date
                        </label>
                        <input
                            id="cp-date"
                    ...
                    <div className="space-y-1.5">
                        <label className="text-sm font-medium" htmlFor="cp-amount">
                            Amount
                        </label>
                        <input
                            id="cp-amount"
                    ...
                    <div className="space-y-1.5">
                        <label className="text-sm font-medium" htmlFor="cp-notes">
                            Notes{" "}
