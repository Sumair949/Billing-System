...
export function PrintActions() {
    // If the page was opened as a popup/new tab, window.close() succeeds —
    // otherwise (navigated to via a server-action redirect), it's a no-op
    // and we fall back to routing to the dashboard.
    function handleDone() {
        window.close();
        window.setTimeout(() => {
